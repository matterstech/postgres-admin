...
;
COMMENT ON VIEW extension_object IS 'List of all object packed in an extension with associated comment';-- based on query from http://wiki.postgresql.org/wiki/Index_Maintenance
